...
public class InstanceManager {
	...
	static String mainPath = "/nodes/instances";
	static String flags = "/flags/instances";
	
	public InstanceManager(String path, String data, String nodeType, ZkConnect connector){
		/*
